...
# Configuration Script – Avangrid EU868 - Rev. A

This **Configuration** script is designed for the **Avangrid EU868** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Avangrid EU868 Rev. A

Este script de **Configuration** está diseñado para el modelo **Avangrid EU868** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
